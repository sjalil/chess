...
public class ImageDisplay extends javax.swing.JFrame implements MoveInterface {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
               ...
               x.setVisible(true);
                ...
                try{
                   // LocateRegistry.createRegistry(1075);
		MoveInterface stub = (MoveInterface) UnicastRemoteObject.exportObject(x, 0);
		String name = "ServerMoveStub";
    ...
    public void move(JLabel x){
        ...
        try {
            client.moveRemote(x, dest.x, dest.y);
    ...
    public void moveRemote(JLabel x,int locx,int locy) throws RemoteException{
        System.out.println("Server performed a move.");
	registry();
        toX= (locx -1)*75 +20;
        toY = (locy -1)*75 +20;
        move(x);
    ...
    public void registry(){
        try{
		String name1 = "ClientStub";
		Registry registry1 = LocateRegistry.getRegistry("localhost");
		client = (MoveInterface) registry1.lookup(name1);
		System.out.println("Server Called Client's Method: ");
			}catch(Exception e){
				e.printStackTrace();
		}
